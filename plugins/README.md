...
| [local-llm-router](./local-llm-router/) | Commands for inspecting and managing local LLM routing | **Commands:** `/models`, `/router-status`, `/router-set` - Inspect and update router config |
